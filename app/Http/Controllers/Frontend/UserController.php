...
class UserController extends Controller {
	...
	public function index() {
		...
		return view( 'front.profile.profile', compact( 'books', 'unseccess_books', 'lang', 'cip_books' ) );
...
//		//request validator
	...
	public function do_register( UserRequest $request ) {
		...
		//send mail
		Mail::to( $email )->send( new register( $lang, $link ) );
	...
	public function send_reset_link( UserRequest $request ) {
		...
		//send mail
		Mail::to( $email )->send( new reset( $lang, $link ) );
