...
$xData["to"]["name"]["data"] = "<strong>American Option</strong>";
...
$xData["payment"]["method1"]["data"] = "<br/><strong>PayPal:</strong> dummy@gmail.com";
//$xData["payment"]["method2"]["data"] = "<br/><strong>Cheque payable to:</strong> YOUR COMPANY NAME";
...
$xData["item"][0]["desc"]["data"] = "<strong>Logo Design</strong><br/>Lorem Ipsum is simply dummy text of the printing and typesetting industry";
$xData["item"][0]["qty"]["data"] = 100;
$xData["item"][0]["rate"]["data"] = 2500;
$xData["item"][0]["total"]["data"] = 25000;
//$xData["item"][1]["name"]["data"] = "Brochure Design";
$xData["item"][1]["desc"]["data"] = "<strong>Brochure Design</strong><br/>Lorem Ipsum has been the industry's standard dummy text.";
$xData["item"][1]["qty"]["data"] = 200;
$xData["item"][1]["rate"]["data"] = 20;
$xData["item"][1]["total"]["data"] = 4000;
//$xData["item"][2]["name"]["data"] = "Website Design";
$xData["item"][2]["desc"]["data"] = "<strong>Website Design</strong><br/>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.";
$xData["item"][2]["qty"]["data"] = 100;
$xData["item"][2]["rate"]["data"] = 2500;
$xData["item"][2]["total"]["data"] = 25000;
//$xData["item"][3]["name"]["data"] = "Invoice Design";
$xData["item"][3]["desc"]["data"] = "<strong>Invoice Design</strong><br/>Lorem Ipsum has been the industry's standard dummy text.";
...
//$xData["footer"]["sincerely"]["label"] = "<strong>Sincerely, </strong>";
//$xData["itemcount"]["count"]["label"] = "Sno.";

//$xData["item"][0]["name"]["label"] = "Service";
$xData["item"][0]["desc"]["label"] = "Task Description";
$xData["item"][0]["rate"]["label"] = "Rate";
