...
<style type="text/css">
    ...
    table.xinvoice-payment-details tr td.xinvoice-payment{
        text-align: left;
    }
...
<div class="xinvoice-box">
    ...
    <?php if (!isset($data["header"]["display"]) || (isset($data["header"]["display"]) && $data["header"]["display"])) { ?>
        <table cellpadding="0" cellspacing="0" class="xinvoice-header" style="<?php if (isset($data["header"]["style"])) echo $data["header"]["style"]; ?>">
            ...
            <tr>
                <td class="xinvoice-document-details">
                    <?php
        ...
        <table cellpadding="0" cellspacing="0" class="xinvoice-invoice-details-table">
            <tr>
                <?php
                if (isset($data["invoice"]))
                    foreach ($data["invoice"] as $key => $val) {
                        ...
                        if (isset($val["display"]) && $val["display"] === false)
                            continue;
                        echo "<td class='xinvoice-invoice-details'>";
                        if (isset($val["style"]))
                            $style = $val["style"];
                        if (isset($val["label"]))
                            echo "<span class='xinvoice-invoice-label'>" . $val["label"] . "</span><br/>";
                        if (isset($val["data"]))
                            echo "<span class='xinvoice-invoice-data' style='" . $style . "'>" . $val["data"] . "</span>";
                        echo "</td>";
