                                        ...
                                        if (!isset($data["from"]["display"]) || (isset($data["from"]["display"]) && $data["from"]["display"] ))
                                            foreach ($data["from"] as $key => $val) {
                                                ...
                                                if (isset($val["style"]))
                                                    $style = $val["style"];
                                                if (isset($val["label"]))
                                                    echo "<span class='xinvoice-invoice-label'>" . $val["label"] . "</span>";
                                                if (isset($val["data"]))
                                                    echo "<span class='xinvoice-invoice-data' style='" . $style . "'>" . $val["data"] . "</span><br/>";
                                            }
                                        ?>
                                    </td>
                                </tr>
