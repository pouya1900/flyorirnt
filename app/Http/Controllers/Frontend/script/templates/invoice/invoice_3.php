...
<style type="text/css">
    ...
    table.xinvoice-items tr td:nth-child(1) {  
        background: #efefef;
    }
    table.xinvoice-items tr td:nth-child(2) {  
        background: #dfdfdf;
    }
    table.xinvoice-items tr td:nth-child(3) {  
        background: #cacaca;
    }
    table.xinvoice-items tr td:nth-child(4) {  
        background: #d6d4d5;
    }
    table.xinvoice-items tr td:nth-child(5) {  
        background: #88b267;
    }
