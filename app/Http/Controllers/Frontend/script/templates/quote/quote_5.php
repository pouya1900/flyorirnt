...
<style type="text/css">
    ...
    table.xinvoice-sender-receiver tr td.xinvoice-receiver {
        width: 50%;
    }
    table.xinvoice-sender-receiver tr td.xinvoice-sender {
        background: #82b87c;
        width: 50%;
        color: #fff;
    }
    ...
    .xinvoice-box table.xinvoice-message tr td{
        text-align: center;
        font-size: 40px;
        color: #82b87c;
    }
    ...
    table.xinvoice-items tr.xitem td:nth-child(1) {  
        color: #82b87c;
    }
    table.xinvoice-items tr.xinvoice-items-even{
      background-color:#dcdcdc;
      font-weight: bold;
    }
    table.xinvoice-items tr.xtotal{
        background:#cacaca;
        color: #000; 
    }
