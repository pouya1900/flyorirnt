        ...
        <ul>
            ...
            <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-8-layer-1"
                     data-x="['center','center','center','center']" data-hoffset="['200','200','30','400']"
                     data-y="['top','top','top','top']" data-voffset="['110','110','110','110']"
                     data-fontsize="['40','40','35','36']" data-width="none" data-height="none" data-whitespace="nowrap"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-8-layer-2"
                     data-x="['center','center','center','center']" data-hoffset="['30','240','30','200']"
                     data-fontsize="['28','28','28','28']"
                     data-y="['top','top','top','top']" data-voffset="['380','380','330','330']" data-width="none"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-8-layer-6" data-x="['left','left','center','center']"
                     data-hoffset="['300','300','200','200']" data-y="['top','top','top','top']"
                     data-voffset="['26','59','30','30']" data-width="none" data-height="none" data-whitespace="nowrap"
            ...
            <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <!-- LAYER NR. 1 -->
                <div class="tp-caption   tp-resizeme" id="slide-9-layer-1" data-x="['center','center','center','center']"
                     data-hoffset="['50','50','30','300']" data-y="['top','top','top','top']"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['center','center','center','center']"
                     ...
                     data-hoffset="['90','90','90','220']" data-y="['top','top','top','top']"
            ...
            <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-10-layer-1" data-x="['left','left','center','center']"
                    data-fontsize="['38','38','38','38']"
                     data-hoffset="['520','400','400','430']" data-y="['top','top','top','top']"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['520','573','350','350']" data-y="['top','top','top','top']"
                     data-voffset="['300','300','201','140']" data-width="none" data-height="none"
                     data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                     data-frames='[{"delay":360,"speed":940,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"+6880","speed":650,"frame":"999","to":"x:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                     data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[10,10,10,10]"
                     data-paddingright="[10,10,10,10]" data-paddingbottom="[10,10,10,10]"
                     ...
                     تعطیلاتت رو الان برنامه ریزی کن
                </div>

                <!-- LAYER NR. 3 -->
                <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['520','573','350','350']" data-y="['top','top','top','top']"
                     data-voffset="['350','350','240','240']" data-width="none" data-height="none"
                     data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                     data-frames='[{"delay":360,"speed":940,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"+6880","speed":650,"frame":"999","to":"x:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                     data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[10,10,10,10]"
                     data-paddingright="[10,10,10,10]" data-paddingbottom="[10,10,10,10]"
            ...
            <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <!-- LAYER NR. 1 -->
                <div class="tp-caption   tp-resizeme" id="slide-10-layer-1" data-x="['left','left','center','center']"
                     data-hoffset="['520','520','450','410']" data-y="['top','top','top','top']"
            ...
            <!-- LAYER NR. 1 -->
            <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['550','550','500','400']" data-y="['top','top','top','top']"
                     ...
                     بدون دغدغه با <br>خدمات فرودگاهی تهران (CIP)
                </div>
            <!-- LAYER NR. 2 -->
            <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['550','550','300','300']" data-y="['top','top','top','top']"
            ...
            <!-- LAYER NR. 3 -->
            <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['550','550','300','320']" data-y="['top','top','top','top']"
                     data-voffset="['200','201','201','205']" data-width="none" data-height="none"
                     data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
            ...
            <!-- LAYER NR. 4 -->
            <div class="tp-caption   tp-resizeme" id="slide-10-layer-2" data-x="['left','left','center','center']"
                     data-hoffset="['550','550','300','240']" data-y="['top','top','top','top']"
                     data-voffset="['280','280','201','280']" data-width="none" data-height="none"
                     data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                ...
                <div class="tp-caption rev-btn " id="slide-10-layer-4" data-x="['left','left','center','center']"
                    data-fontsize="['20','20','20','18']"
                     data-hoffset="['400','400','300','350']" data-y="['top','top','top','top']"
                     data-voffset="['391','405','380','360']" data-width="['220','220','220','220']"
