    ...
    <div class="container">
        <div class="row">
            <div id="search_form_main_container" class="col-lg-6">
                <form method="post" :action="submit_url" class="search_form"
                      data-toggle="1">
                                ...
                                <ul class="nav nav-tabs flex-column" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#home" role="tab">
                                            <i class="fas fa-plane"></i>{{ trs.flight }}</a>
                                    </li>
                                </ul>
                                <div class="clearfix">
                                            ...
                                            <div class="col-4 col-lg-12 padding-right-5px padding-left-5px">
                                                <div class="home_page_filter--item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="stops0"
                                                               class="custom-control-input"
                                                               id="depart_stop0"
                                                               :checked="setting.search_nonstop ? true : false">
                                                        <label class=" custom-control-label"
                                                               for="depart_stop0">{{ trs.none_stop }}</label>
                                                    </div>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="stops1"
                                                               class="custom-control-input"
                                                               id="depart_stop1"
                                                               :checked="setting.search_one_stop ? true : false">
                                                        <label class="custom-control-label"
                                                               for="depart_stop1">1 {{ trs.stop }}</label>
                                                    </div>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="stops2"
                                                               class="custom-control-input"
                                                               id="depart_stop2"
                                                               :checked="setting.search_two_stops ? true : false">
                                                        <label class="custom-control-label"
                                                               for="depart_stop2">2+
                                                            {{ trs.stops_in_Counting }}</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="home_page_filter--item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="bar0" class="custom-control-input"
                                                               id="bar0"
                                                               :checked="setting.search_without_bar ? true :false">
                                                        <label class="custom-control-label"
                                                               for="bar0">{{ trs.without_bar }}</label>
                                                    </div>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox"
                                                               name="bar1"
                                                               class="custom-control-input"
                                                               id="bar1"
                                                               :checked="setting.search_with_bar ? true : false">
                                                        <label class="custom-control-label"
                                                               for="bar1">{{ trs.with_bar }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4 col-lg-12 padding-right-5px padding-left-5px">
                                                <div class="home_page_filter--item">
                                                    <span>{{ trs.waiting_time_search }}</span>
                                        ...
                                        <div class="air_trip_type">
                                            <div class="row margin-right-0px margin-left-0px">
                                                <div class="col-4 way active_tab" data-toggle="R"
                                                     data-id="1">{{ trs.round_trip }}
                                                </div>
                                                <div class="col-4 way" data-toggle="O"
                                                     data-id="1">{{ trs.one_way }}
                                                </div>
                                                <div class="col-4 way" data-toggle="M"
                                                     data-id="1">{{ trs.multi_city }}
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row margin-0px">
                                                        ...
                                                        <div class="col-4 padding-right-5px padding-left-5px">
                                                            ...
                                                            <div class="count_h">
                                                                ...
                                                                <div
                                                                    class="font-weight-600 margin-bottom-5px">
                                                                    @lang('trs.adults')
                                                                </div>
                                                                <div class="counter_h">
...
export default {
    ...
    props: ['trs', 'submit_url', 'csrf', 'setting'],
    name: 'search',
    methods: {},
    data() {
        return {}
