...
Class PDOModel {
    ...
    private $xinvoiceErrCtrl;            // set error controller
    ...
    public function setErrorCtrl(XinvoiceErrorCtrl $xinvoiceErrCtrl) {
        $this->xinvoiceErrCtrl = $xinvoiceErrCtrl;
    }
   ...
   /* Returns having condition */
    ...
    private function setErrors($error) {
        ...
        if (isset($this->xinvoiceErrCtrl)) {
            $this->xinvoiceErrCtrl->addError($error, TRUE);
        } else {
            $this->error[] = $error;
