...
$xData["footer"]["note"]["data"] = "<strong>Company Name, Inc</strong>";
//$xData["item"][0]["name"]["data"] = "";
$xData["item"][0]["desc"]["data"] = "Logo Design <br/>Lorem Ipsum is simply dummy text of the printing and typesetting industry";
$xData["item"][0]["qty"]["data"] = 100;
$xData["item"][0]["rate"]["data"] = 2500;
$xData["item"][0]["total"]["data"] = 25000;
//$xData["item"][1]["name"]["data"] = "Brochure Design";
$xData["item"][1]["desc"]["data"] = "Brochure Design <br/>Lorem Ipsum has been the industry's standard dummy text.";
$xData["item"][1]["qty"]["data"] = 200;
$xData["item"][1]["rate"]["data"] = 20;
$xData["item"][1]["total"]["data"] = 4000;
//$xData["item"][2]["name"]["data"] = "Website Design";
$xData["item"][2]["desc"]["data"] = "Website Design <br/>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.";
$xData["item"][2]["qty"]["data"] = 100;
$xData["item"][2]["rate"]["data"] = 2500;
$xData["item"][2]["total"]["data"] = 25000;
//$xData["item"][3]["name"]["data"] = "Invoice Design";
$xData["item"][3]["desc"]["data"] = "Invoice Design <br/>Lorem Ipsum has been the industry's standard dummy text.";
...
$xData["from"]["name"]["label"] = "From: <br/>";
$xData["to"]["name"]["label"] = "To: <br/>";
...
$xData["invoice"]["total_due"]["style"] = "color: #84a9c3; font-size:16px; font-weight:bold;";
