...
$xData["from"]["name"]["label"] = "Questions? Contact Us: <br/>";
$xData["to"]["name"]["label"] = "For: <br/>";
...
$xData["footer"]["note"]["label"] = "<strong>Terms & Conditions: </strong><br/>";
//$xData["itemcount"]["count"]["label"] = "Sno.";
//$xData["item"][0]["name"]["label"] = "Service";
$xData["item"][0]["desc"]["label"] = "Work";
$xData["item"][0]["qty"]["label"] = "Hours";
...
$xData["message"]["thankyou"]["style"] = "font-size:24px;";
...
$xData["item"][0]["qty"]["format"] = array("suffix"," hrs.");
