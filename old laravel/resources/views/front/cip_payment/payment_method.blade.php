<form action="{{route('cip_process_payment',['token'=>$book->token]). ($lang!="de"? "?lang=".$lang : "")}}" method="post">
    {{csrf_field()}}
...
// Set up the transaction
        createOrder: function (data, actions) {
            ...
            return fetch('{{route('cip_process_payment',['token'=>$book->token]). ($lang!="de"? "?lang=".$lang : "")}}', {
                method: 'get',
                headers: {
