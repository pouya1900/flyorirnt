                            ...
                            <div class="tab-pane active" id="home" role="tabpanel">
                                ...
                                <div class="air_trip_type">
                                    <div class="row margin-right-0px margin-left-0px">
                                        ...
                                        <div class="col-6 way" data-toggle="O" data-id="1">@lang('trs.one_way')</div>
                                    </div>
                                ...
                                <div id="round_trip" class="custom_nav active_nav">
                                    <form method="post" action="{{route('search'). ($lang!="de"? "?lang=".$lang : "")}}"
                                          class="search_form" data-toggle="1">
                                        {{ csrf_field()  }}
                                        ...
                                        <div class="form-group margin-bottom-5px">
                                            ...
                                            <div class="destination">
                                                ...
                                                <input name="destination" type="text"
                                                       ...
                                                       data-validation="0" data-sec="2" placeholder="@lang('trs.flying_to')"
                                                       autocomplete="off">
