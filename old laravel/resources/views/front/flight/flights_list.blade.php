...
>
    ...
    @if(isset($flight) && !empty($flight))
        @foreach($flight as $main_key=>$item)
            ...
            <div class="{{$item["ValidatingAirlineCode"]=="IR" ? "our_recommend_container" : ""}}">
                        ...
                        <span>
                         {{\App\Services\MyHelperFunction::turn_class($item["class"])}}/{{$item["class_code"]}}
                                        ...
                                        <div class="flight_item col-4 deal_button_md_d">
                                            <a href="{{route('passengers_info',['token'=>$item["token"]]). ($lang!="de"? "?lang=".$lang : "")}}">
                                    ...
                                    <div class="details_link" data-toggle="collapse"
                                       ...
                                       role="button"
                                       aria-expanded="false" aria-controls="flight_details{{isset($search_data["main_vendor"]) ? 0 : $search_data["render"]}}_{{$key}}" data-tar="{{$key}}"
